...
if ($rs = $conn->query($sql)) {
    if ($rs->num_rows > 0) {
        while ($row = $rs->fetch_assoc()) {
            ...
            $date = $row['BusinessEstablish'];

            // Convert the date string to a UNIX timestamp and then format it as desired
                        ...
                        <div class="col-lg-4">
                            <div class="profile-agent-widget">
                                <ul>
                                    ...
                                    <li>Contact Us <span>'.$row['BusinessNumber'].'</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4">
...
$sql3 = "SELECT * FROM business_carousel WHERE bus_id = :bus_id";
$stmt3 = $pdo->prepare($sql3);
$stmt3->bindParam(':bus_id', $id, PDO::PARAM_STR);
$stmt3->execute();
